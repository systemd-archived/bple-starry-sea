...
public class Engine : BasePart
{
	...
	public override bool CanBeEnabled()
	{
		...
		{
			if (part.ConnectedComponent == base.ConnectedComponent && !part.IsEngine() && part.CanBeEnabled() && part.IsPowered())
			{
				return true;
			}
		}
	...
	public override void OnButtonTriggered(UIPartTriggerButton button)
	{
	}
