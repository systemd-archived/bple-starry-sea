...
namespace Spine.Unity.Modules
{
	...
	public class SkeletonUtilityGroundConstraint : SkeletonUtilityConstraint
	{
		...
		public override void DoUpdate()
		{
			...
			else if ((!useRadius) ? Physics.Raycast(rayOrigin, rayDir, out hitInfo, castDistance + groundOffset, groundMask) : Physics.SphereCast(rayOrigin, castRadius, rayDir, out hitInfo, castDistance + groundOffset, groundMask))
			{
