...
public class BracketFrameManager : PartManager
{
	public override StatusCode Status => StatusCode.Running;

	public static BracketFrameManager Instance { get; private set; }
	...
	private void DestroyJoints()
	{
		...
		foreach (Contraption.JointConnection item in Contraption.Instance.JointMap)
		{
			...
			for (int i = 0; i < 2; i++)
			{
				...
				if (basePart.IsBracketFrame() && !basePart2.IsBracketFrame())
				{
