...
public class LeaderboardPlayerInfo : MonoBehaviour
{
	...
	private void UpdatePlayerStats()
	{
		...
		int num2 = GameProgress.GetInt("cake_race_coins_won");
		TextMeshHelper.UpdateTextMeshes(totalCoinsWonLabel, $"[snout] {num2}");
		TextMeshSpriteIcons.EnsureSpriteIcon(totalCoinsWonLabel);
		int num3 = GameProgress.GetInt("cake_race_highest_rank");
		TextMeshHelper.UpdateTextMeshes(highestRankLabel, (num3 <= 0) ? "-" : num3.ToString());
	}
