...
public class PropertyPanel : INBehaviour
{
	...
	protected virtual void Initialize()
	{
		...
		try
		{
			m_textColor = (Color)HexColor.Parse(INSettings.GetString(INFeature.PropertyPanelColor));
		}
		catch
		{
			m_textColor = (Color)HexColor.Parse(INSettings.GetInitialString(INFeature.PropertyPanelColor));
		}
		try
		{
			m_outlineColor = (Color)HexColor.Parse(INSettings.GetString(INFeature.PropertyPanelOutlineColor));
		}
		catch
		{
			m_outlineColor = (Color)HexColor.Parse(INSettings.GetInitialString(INFeature.PropertyPanelOutlineColor));
		}
	}
