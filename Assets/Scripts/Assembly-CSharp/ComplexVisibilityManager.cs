...
public class ComplexVisibilityManager : Singleton<ComplexVisibilityManager>
{
	public enum Condition
	{
		...
		SnoutCoinShopOpen = 2,
		LootWheelOpen = 3,
		LootCrateDialogOpen = 4,
		InMainMenu = 5,
		InEpisodeSelection = 6,
		InLevelSelection = 7,
		InWorkshop = 8,
		InCakeRaceMenu = 9,
		InKingPigFeed = 10,
		InLevel = 11,
		LevelCompleteScreen = 12,
		CakeRaceCompleteScreen = 13,
		MainMenuPromo = 14,
		PurchaseProductConfirmation = 15,
		NotificationPopupOpen = 16,
		ShopLockedScreen = 17,
		IsOdyssey = 18,
		CakeRaceUnlockDialogOpen = 19,
		DailyChallengeDialogOpen = 20,
		WorkshopIntroductionOpen = 21,
		PurchaseRoadHogsPartsOpen = 22
	}
