...
public class GadgetButton : Button
{
	...
	private void UpdateGadgetState()
	{
		...
		bool flag = ((m_partTier != BasePart.PartTier.Regular) ? levelManager.ContraptionRunning.AnyPartsEnabled(m_partType, m_partTier, m_direction) : levelManager.ContraptionRunning.AnyPartsEnabled(m_partType, m_direction));
