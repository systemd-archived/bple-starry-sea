...
public class DessertsCounter : WPFMonoBehaviour
{
	...
	{
		base.gameObject.SetActive(WPFMonoBehaviour.levelManager.m_sandbox && (GameProgress.GetBool("ChiefPigExploded") || INSettings.GetBool(INFeature.EnableDesserts)));
		if (INUserSettings.Instance.LevelSceneSettings.HideStarAndDessertCounter)
		{
